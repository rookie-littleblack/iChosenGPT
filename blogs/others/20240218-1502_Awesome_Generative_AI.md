...
- [privateGPT](https://github.com/imartinez/privateGPT) - 使用LLMs的力量在没有互联网连接的情况下向您的文档提问。
...
- [Eleven Labs](https://beta.elevenlabs.io/) - AI语音生成器。
...
- [生成式AI景观](https://github.com/ai-collection/ai-collection) - 用于生成式AI应用程序的精选列表。
