...
from models.chatglm3.composite_demo import demo_tool, demo_chat, demo_ci
import streamlit as st


# st.set_page_config(
#     page_title="ChosenGPT",
#     page_icon=":robot:",
#     layout='centered',
...
You are iChosenGPT, a large language model trained by ChosenMed and iChosenKG. Follow the user's instructions carefully. Respond using markdown.
'''.strip()
