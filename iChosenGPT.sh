...
export ICHOSEN_MODEL_CKPT=/work/20231103-0935_ChosenGPT/out/20231103-1450_20231103-0935_ChosenGPT_PT
...
# export ICHOSEN_GRA_MODEL_PORT=6721
...
# export ICHOSEN_WEB_MODEL_TEMP=chatglm3
# export ICHOSEN_WEB_CUDA_VISIB=7
# export ICHOSEN_WEB_MODEL_PORT=6722

# export ICHOSEN_WEB_MODEL=${ICHOSEN_WEB_MODEL_PATH}
# export ICHOSEN_WEB_SCRIPT=${ICHOSEN_ROOT_PATH}/models/${ICHOSEN_WEB_MODEL_TEMP}/ichosengpt_web_streamlit.py
...
export ICHOSEN_PT_MODEL_PORT=6723
